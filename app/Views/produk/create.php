          ...
          <div class="title-wrapper pt-30">
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <div>
                    <form action="<?= site_url('data_produk/store') ?>" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="harga" step="0.01" required><br>
                        </div>
                        <div class="mb-3">
                    ...
                    <a href="<?= site_url('data_produk') ?>" class="btn btn-secondary">Kembali</a>
                </div>
              </div>
            </div>
            <!-- end row -->
