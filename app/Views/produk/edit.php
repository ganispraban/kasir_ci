          ...
          <div class="title-wrapper pt-30">
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <div>
                    <form action="<?= site_url('data_produk/update/'.$produk['id']) ?>" method="post">
                        <label>Nama:</label>
                        <input type="text" name="nama" value="<?= $produk['nama'] ?>" required><br>
                        <label>Harga:</label>
                        <input type="number" name="harga" step="0.01" value="<?= $produk['harga'] ?>" required><br>
                        <label>Stok:</label>
                        <input type="number" name="stok" value="<?= $produk['stok'] ?>" required><br>
                        <input type="submit" value="Update">
                    </form>
                    <a href="<?= site_url('data_produk') ?>">Kembali</a>
                </div>
              </div>
            </div>
            <!-- end row -->
