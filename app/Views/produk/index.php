            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <div class="btn-container">
                  <a href="<?= site_url('data_produk/create') ?>" type="button" class="btn btn-primary">Tambah Produk</a>
                </div><br>
                    ...
                    <tbody>
                        <?php foreach ($produk as $item): ?>
                            <tr>
                                ...
                                <td><?= $item['stok'] ?></td>
                                <td>
                                    <a href="<?= site_url('data_produk/edit/'.$item['id']) ?>" type="button" class="btn btn-warning">Edit</a>
                                    <a href="<?= site_url('data_produk/delete/'.$item['id']) ?>" type="button" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
