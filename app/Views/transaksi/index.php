...
<html lang="en">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <div class="btn-container">
                  <a href="<?= site_url('data_transaksi/create') ?>" type="button" class="btn btn-primary">Tambah Transaksi</a>
                </div><br>
                  ...
                  <table class="table table-bordered" style="text-align: center;">
                    <thead>
                      <tr>
                          ...
                          <th scope="col">Total Transaksi (Rp)</th>
                          <th scope="col">Diskon (%)</th>
                          <th scope="col">Uang Dibayar (Rp)</th>
                    ...
                    <tbody>
                      <?php foreach ($transaksi as $item): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($item['status_pembayaran'] == 'Belum Dibayar'): ?>
                                    <a href="<?= site_url('data_transaksi/edit/'.$item['id']) ?>" class="btn btn-warning">Edit</a>
                                    <a href="<?= site_url('data_transaksi/delete/'.$item['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?')" class="btn btn-danger">Delete</a>
                                    <a href="<?= site_url('data_transaksi/bayar/'.$item['id']) ?>" class="btn btn-primary">Bayar</a>
                                <?php else: ?>
  ...
  <script>
      // Check if payment success flashdata is set, then show modal
